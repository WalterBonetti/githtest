...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text('CLICK ANYWHERE TO START', font, text_col, 100, screen_heigth //2 + 100)
        elif game_over == 1:
            draw_text('YOU WON!', font, text_col, 240, screen_heigth //2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, text_col, 100, screen_heigth //2 + 100)
        elif game_over == -1:
            draw_text('YOU LOST!', font, text_col, 240, screen_heigth //2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, text_col, 100, screen_heigth //2 + 100)
